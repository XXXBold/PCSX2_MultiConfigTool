...
PCSX2Tool::PCSX2Tool()
{
  ...
  strTmp.assign(PCSX2_TOOL_PATH_DEFAULT_GAMES);
#ifdef _WIN32
  if((pcTmp=getenv("USERNAME")) && (pcTmp[0] != '\0'))
  {/* Found Env variable */
    strTmp.append(pcTmp);
    strTmp.append("\\");
  }
#elif __linux__
  if((pcTmp=getenv("USER")) && (pcTmp[0] != '\0'))
  {/* Found Env variable */
    strTmp.append(pcTmp);
    strTmp.append("/");
  }
  ...
  strTmp.assign(PCSX2_TOOL_PATH_DEFAULT_CFG);
#ifdef _WIN32
  if((pcTmp=getenv("USERNAME")) && (pcTmp[0] != '\0'))
  {/* Found Env variable */
    strTmp.append(pcTmp);
  ...
  {/* Found Env variable */
    strTmp.append(pcTmp);
    strTmp.append("/.config/PCSX2/inis/");
  }
#endif /* _WIN32 */
  ...
  strTmp.assign(PCSX2_TOOL_PATH_DEFAULT_USR_CFG);
#ifdef _WIN32
  if((pcTmp=getenv("USERNAME")) && (pcTmp[0] != '\0'))
  {/* Found Env variable */
    strTmp.append(pcTmp);
